...
| To repozytorium zawiera kod źródłowy strony **JustCloud.pl**. | This repository contains the source code for the **JustCloud.pl** website. |
| Jest to lekka, **statyczna strona internetowa** zaprojektowana z myślą o prostocie i wydajności. | It is a lightweight, **static website** designed for simplicity and performance. |
